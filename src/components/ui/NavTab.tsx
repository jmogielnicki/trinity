...
const BASE =
  'bg-transparent border-0 border-b-[3px] border-solid px-2.5 py-2.5 sm:px-4 sm:py-3 text-md font-semibold cursor-pointer -mb-px whitespace-nowrap flex-shrink-0 flex items-center gap-2';
