...
function CompareBar({
	...
	return (
		<div className="sticky top-[var(--header-h)] z-30 -mx-4 px-4 flex flex-wrap items-center gap-x-3.5 gap-y-2 py-2.5 mb-2 border-b border-border-light min-h-[52px]" style={{ background: '#fcfbf8' }}>
